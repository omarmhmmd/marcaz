...
function toGatsbyNode(doc, options) {
    ...
    return __assign(__assign(__assign({}, withRefs), rawAliases), { id: documentIds_1.safeId(overlayDrafts ? documentIds_1.unprefixId(doc._id) : doc._id, createNodeId), children: [], internal: {
